...
public class SeedData {
	...
	public SeedData(skillsRepository skills, RequestRepository requests) {
		...
		requests.save(new RequestForm("N912121","Griswold","Jenny","Boston","Claims","Personal","Call","8675309"));
		

		requests.save(new RequestForm("N0211099","Brian","Griffin","Indy-yall","Claims","Personal","Email","test@test.com"));
